<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="p-4">
            <form method="POST" action="{{ route('search-terms.store') }}">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3" id="replies_content">
                    <label for="replies" class="form-label">Reply(ies)</label>
                    <textarea style="border: solid black 1px; outline: 0" name="replies[]" data-id="1" id="replies_1" class="form-control mt-2 replies"></textarea>
                </div>
